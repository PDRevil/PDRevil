# -*- coding: utf-8 -*-
"""
Created on Mon Dec 20 15:18:17 2021
...
s3.sum() #'1,2003,0004,000' >>> 천 단위 구분기호(,000)문자열 결합
...
# 0    abc
# dtype: object
s1[s1.str.contains('e')] # 각 원소에서 'e'를 포함하는 원소 추출
...
# find: 위치값 리턴
Series(['abc@abc.com','kth960302@abc.com'])
s3 = Series(['abc@abc.com','kth960302@abc.com'])
s3.str.find('@')
