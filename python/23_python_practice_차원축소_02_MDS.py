# -*- coding: utf-8 -*-
"""
Created on Thu Jan  6 15:49:28 2022
...
m_mds2.stress_     # 235.38995213035537 --> 적합도 평가(.stress_)
...
stress  # 3520.5655903892603

stress1 = np.sqrt(stress/(0.5*np.sum(DA**2)))

stress1  # 0.18559612101013562

# 3차원

m_mds3.stress_ # 11.207154977731687
m_mds3.embedding_
