# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 14:55:08 2021

@author: kth96
"""

# 16. NA 결측치 처리, 중복값 제거 (IMFORTANT)
...
df1.dropna() # NA 를 하나라도 포함한 행 제거
df1.dropna(how='any') # NA 를 하나라도 포함한 행 제거
df1.dropna(how='all') # 모든 값이 NA인 행 제거(결측치 처리시 반드시 사용**)

df1.dropna(thresh=2)     # NA 가 아닌 값이 최소 2개 이상이면 제거하지 않음(실무에서 유용**)
