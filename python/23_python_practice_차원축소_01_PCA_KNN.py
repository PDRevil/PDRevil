# -*- coding: utf-8 -*-
"""
Created on Thu Jan  6 14:36:05 2022
...
m_knn1.fit(train_x1, train_y1) # fit는 train data만 넣어야함!!!, KNeighborsClassifier()
m_knn1.score(test_x1, test_y1) # 0.9473684210526315
...
m_knn2.score(test_x2, test_y2) # 0.97
